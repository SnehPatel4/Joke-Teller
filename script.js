...
function tellMe(joke) {
    ...
    VoiceRSS.speech({
        key: 'fcfaf98f5f164b629c027b70002e5668',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    ...
    try{
        ...
        if(data.setup) {
            joke = `${data.setup} ... ${data.delivery}`; //this execute when joke is in twopart.
        } else {
            joke = data.joke; //this part execute when joke type is single.
        }
        //Text-to-Speech API
        tellMe(joke);
        //Disabled Button
